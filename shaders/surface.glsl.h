...
/*
    ...
    Cmdline:
        sokol-shdc --input C:\Users\vszbo\Documents\c++\Gungutils\shaders\surface.glsl --output C:\Users\vszbo\Documents\c++\Gungutils\shaders\surface.glsl.h --slang glsl430

    Overview:
    =========
    Shader program: 'surface':
        Get shader desc: surface_shader_desc(sg_query_backend());
        Vertex Shader: surface_vs
        Fragment Shader: surface_fs
        Attributes:
            ATTR_surface_position => 0
            ATTR_surface_texcoord => 1
    Bindings:
        Texture 'u_texture2D':
...
#error "Please include sokol_gfx.h before surface.glsl.h"
#endif
...
#endif
#endif
#define ATTR_surface_position (0)
#define ATTR_surface_texcoord (1)
...
*/
static const uint8_t surface_vs_source_glsl430[319] = {
...
*/
static const uint8_t surface_fs_source_glsl430[231] = {
...
static inline const sg_shader_desc* surface_shader_desc(sg_backend backend) {
    if (backend == SG_BACKEND_GLCORE) {
        static sg_shader_desc desc;
        static bool valid;
        if (!valid) {
            valid = true;
            desc.vertex_func.source = (const char*)surface_vs_source_glsl430;
            desc.vertex_func.entry = "main";
            desc.fragment_func.source = (const char*)surface_fs_source_glsl430;
